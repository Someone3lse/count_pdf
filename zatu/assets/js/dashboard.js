...
function addZero(i) {
  ...
  $("a#a_notificacao").click(function(){
    var id = $(this).attr('value');
    postToURL(PORTAL_URL + 'view/rh/servidor_atualizacao/conferencia', {id: id});
    return false;
  });
  ...
  $("a#a_redefinir_senha").click(function(){
    ...
    postToURL(PORTAL_URL + 'redefinir_senha', {login: login});
    return false;
  });
});
function conferenciaAtualizacao(id){
  postToURL(PORTAL_URL + 'view/sacad/servidor_atualizacao/conferencia', {id: id});
}
function btnVisualizar(elem){
  var id = $(elem).parents('tr').children('input#td_id').val();
  postToURL(PORTAL_URL + 'view/rh/servidor_atualizacao/visualizar', {id: id});
  return false;
}
