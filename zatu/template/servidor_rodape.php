...
<script type="text/javascript" src="<?= PLUGINS_FOLDER; ?>sweetalert/sweetalert2.min.js"></script>
<script type="text/javascript" src="<?= PLUGINS_FOLDER; ?>sweetalert/sweetalert2.custom.js"></script>
<script type="text/javascript" src="<?= PLUGINS_FOLDER; ?>jquery-mask-1.14/jquery.mask.js"></script>
<!-- <script type="text/javascript" src="<?= JS_FOLDER; ?>jquery.validate.min.js"></script> -->
...
<!-- <script type="text/javascript" src="<?= JS_FOLDER; ?>pages/validation.js"></script> -->
...
<script type="text/javascript" src="<?= JS_FOLDER; ?>pages/pace.js"></script>
<script type="text/javascript" src="<?= JS_FOLDER; ?>data_table.js"></script>
<script type="text/javascript" src="<?= JS_FOLDER; ?>sidebar.js"></script>
<script type="text/javascript" src="<?= JS_FOLDER; ?>servidor_dashboard.js"></script>
