      ...
      <div class="d-inline-block align-items-center">
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Lista de processos</li>
          </ol>
        </nav>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/sacad/servidor_atualizacao/dashboard.js"></script>