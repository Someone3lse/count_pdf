        ...
        <div class="box-header">
          <h4 class="box-title font-weight-bold">
            <div class="d-flex align-items-center justify-content-between">
              <div class="icon rounded-circle font-size-30"><i class="fal fa-chart-network mr-10"></i></div>
              <span id="titulo_form"> NOVO TIPO DE SECRETARIA</span>
            </div>
          </h4>
      ...
      <div class="box box-solid bg-info">
        <div class="box-header">
          <h4 class="box-title font-weight-bold">
            <div class="d-flex align-items-center justify-content-between">
              <div class="icon rounded-circle font-size-30"><i class="fal fa-chart-network mr-10"></i></div>
              <span id="titulo_form"> LISTA DE SECRETARIAS</span>
        ...
        <div class="box-body">
          ...
          <div class="table-responsive">
            <table id="table_modelo_01" class="table table-striped">
