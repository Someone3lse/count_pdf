              ...
              <tbody>
                ...
                foreach ($rsServidores as $kObj => $vObj) {
                  ...
                  <tr>
                    ...
                    <td>
                      <button class="waves-effect waves-light btn btn-info btn-rounded" onclick="btnVisualizar(this);">
                        <i class="fal fa-search"></i> VER PROCESSO
                      </button>
                      <?php
                      if (in_array($vObj['situacaoServidorUltima']['sacad_situacao_servidor_atualizacao_id'], [5, 6, 12]) && (((in_array($vObj['eo_setor_unidade_organizacional_id'], array_column($rsSetoresConferidor, 'suo_id')))) || (in_array($vObj['eo_setor_unidade_organizacional_id_2'], array_column($rsSetoresConferidor, 'suo_id'))))) {
                        ?>
                        <button href="#" class="waves-effect waves-light btn btn-warning btn-rounded" onclick="btnConferir(this);">
                          <i class="fal fa-search"></i> CONFERIR DADOS
                        </button>
                        <?php
                      }
                      ?>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/rh/servidor_atualizacao/dashboard.js"></script>