...
foreach ($rsAtestadores as $kObj => $vObj) {
  ...
  $rsAtestadores[$kObj]['sas'] = $pesquisaId;
      ...
      <div class="d-inline-block align-items-center">
          <nav>
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Chefe Imediato</li>
          </ol>
        </nav>
      </div>
    </div>
        ...
        <div class="box-body">
          <form class="" id="form_atestador" name="form_atestador" method="post" action="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label for="usuario">Período de vigencia de chefe imediato<span class="text-danger"></span>: </label>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="dt_inicio">Data de inicio: <span class="text-danger">*</span></label>
                  <div class="input-group mb-3 controls">
                    <input type="text" class="form-control date_format" minlength="10" id="dt_inicio" name="dt_inicio" placeholder="Data início de vigencia de chefe imediato" title="exemplo: 31/12/2022" value="" required />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="dt_fim">Data de fim: <span class="text-danger"></span></label>
                  <div class="input-group mb-3 controls">
                    <input type="text" class="form-control date_format" minlength="10" id="dt_fim" name="dt_fim" placeholder="Data fim de vigencia de chefe imediato" title="exemplo: 31/12/2022" value="" required />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="box-body">
            <form class="" id="pesquisa_atestacao" name="pesquisa_atestacao" method="post" action="">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="chefe_imediato">CHEFE IMEDIATO<span class="text-danger"></span>: </label>
                    <div class="input-group mb-3 controls">
                      <input type="text" class="form-control" minlength="1" id="chefe_imediato" name="chefe_imediato" placeholder="Nome do chefe" value=""/>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-3 controls">
                      <input type="text" class="form-control" id="periodo" name="periodo" placeholder="Nome do periodo" value=""/>
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-3 controls">
                      <input type="text" class="form-control" id="setores" name="setores" placeholder="Setores" value=""/>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
      ...
      <div class="box box-solid bg-info">
        <div class="box-header">
          <h4 class="box-title font-weight-bold">
            <div class="d-flex align-items-center justify-content-between">
              <div class="icon rounded-circle font-size-30"><i class="fal fa-home-lg mr-10"></i></div>
              <span id="titulo_form"> LISTA DE CHEFES IMEDIATOS</span>
            ...
            <table id="table_modelo_01" class="table table-hover">
              ...
              <tbody>
                ...
                foreach ($rsAtestadores as $kObj => $vObj) {
                  ...
                  ?>
                  <tr>
                    <input type="hidden" id="td_id" value="<?= $vObj['seg_usuario_id_atestador']; ?>">
                    <input type="hidden" id="td_dt_inicio" value="<?= obterDataBRTimestamp($vObj['dt_inicio']); ?>">
                    <input type="hidden" id="td_dt_fim" value="<?= obterDataBRTimestamp($vObj['dt_fim']); ?>">
                    <td id="td_count"><?= $kObj+1; ?></td>
                    <td id="td_nome">Nome: <?= $vObj['atestador_nome']; ?><br>CPF: <?= $vObj['atestador_cpf']; ?><br>Data Nasc.: <?= obterDataBRTimestamp($vObj['atestador_dt_nasc']); ?></td>
                    <td id="td_periodo">Inicio: <?= obterDataBRTimestamp($vObj['dt_inicio']); ?><br>Fim: <?= obterDataBRTimestamp($vObj['dt_fim']); ?></td>
                    <td id="td_setores">
                      <?php 
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/rh/atestador/dashboard.js"></script>