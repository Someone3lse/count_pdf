...
<section class="pt-0">
  <form id="form_servidor_vinculo" class="" name="form_servidor_vinculo" method="post" action="">
    <input type="hidden" id="vinculo_servidor_id" name="id" class="servidor_id" value="<?= $id; ?>">
    <?php
    $countVinculos = 0;
    if (sizeof($rsServidorVinculos) > 0) {
      foreach ($rsServidorVinculos as $kObjVinculo => $vObjVinculo) {
        ...
        <div id="box_vinculo" class="box_vinculo box box-outline-info">
          ...
          <div class="box-header">
            <strong>VÍNCULO A OUTRO ÓRGÃO/SECRETARIA - <span><?= $countVinculos; ?></span></strong>
          </div>
          <div class="box-body">
            <div class="row mt-10">
              <div class="col-md-12">
                <div class="form-group">
                  <label for="vinculo_local_s">Local<span class="text-danger" validator></span>: </label>
            ...
            <div class="row mt-10">
              <div class="col-md-4">
                <div class="form-group">
                  <label for="vinculo_esfera_s">Esfera<span class="text-danger" validator></span>: </label>
                  <div class="input-group mb-3 controls">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="vinculo_cargo_s">Cargo<span class="text-danger" validator></span>: </label>
                  <div class="input-group mb-3 controls">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="vinculo_carga_horaria_s">Carga horária<span class="text-danger" validator></span>: </label>
                  <div class="input-group mb-3 controls">
                    <input type="text" class="form-control" minlength="3" id="vinculo_carga_horaria_s_<?= $countVinculos; ?>" name="vinculo_carga_horaria_s[]" placeholder="Carga horária de vinculo do servidor" value="<?= $vObjVinculo['carga_horaria']; ?>" allempty/>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div id="box_vinculo" class="box_vinculo box box-outline-info">
        ...
        <div class="box-header">
          <strong>VÍNCULO A OUTRO ÓRGÃO/SECRETARIA - <span>1</span></strong>
        </div>
        <div class="box-body">
          <div class="row mt-10">
            <div class="col-md-12">
          ...
          <div class="row mt-10">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="vinculo_carga_horaria_s">Carga horária<span class="text-danger" validator></span>: </label>
                <div class="input-group mb-3 controls">
                  <input type="text" class="form-control" minlength="3" id="vinculo_carga_horaria_s" name="vinculo_carga_horaria_s[]" placeholder="Carga horária de vinculo do servidor" value="" allempty/>
                </div>
              </div>
            </div>
          </div>
