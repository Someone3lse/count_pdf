...
// $id                   = strip_tags(@$_POST['servidor_atualizacao_bancario_id_s']);
...
//       $stmt = $db->prepare('
//         UPDATE sacad_servidor_atualizacao_bancario 
//         SET
...
//       exit();
//     } else {
//       $stmt = $db->prepare('INSERT INTO sacad_servidor_atualizacao_bancario 
//         (sacad_servidor_atualizacao_id, 
//         bancario_bsc_banco_conta_tipo_id, 
//         bancario_bsc_banco_id, 
//         bancario_agencia, 
