...
$id                   = strip_tags(@$_POST['servidor_atualizacao_documento_id_s']);
...
try {
  ...
  if (is_numeric($atualizacaoId) && $atualizacaoId != "" && $atualizacaoId != 0 ) {
    ...
    if (is_numeric($id) && $id != "" && $id != 0 ) {
      $stmt = $db->prepare('
        UPDATE sacad_servidor_atualizacao_documento 
        SET
        sacad_servidor_atualizacao_id = ?, 
        rg_numero = ?, 
        rg_dt_emissao = ?, 
      ...
      $stmt = $db->prepare('INSERT INTO sacad_servidor_atualizacao_documento 
        (sacad_servidor_atualizacao_id, 
        rg_numero, 
        rg_dt_emissao, 
        rg_orgao_expedidor, 
