...
<body class="hold-transition theme-primary bg-img login" style="background-image: url(http://localhost:80/zatu/assets/images/fundo_esquerdo.png) , url(http://localhost:80/zatu/assets/images/fundo_direito.png);">
                  ...
                  if ($login == '' && $rsCount == 0) {
                    ...
                    <div class="row"> 
                      <div class="col-6 text-center">
                        <button type="reset" class="btn btn-info btn-login mt-10" onclick="window.location = '<?= PORTAL_URL ;?>servidor_dashboard';"><strong>Voltar</strong></button>
                      </div>
                      <div class="col-6 text-center">
  ...
  <script type="text/javascript" src="<?= JS_FOLDER; ?>servidor_redefinir_senha.js"></script>
